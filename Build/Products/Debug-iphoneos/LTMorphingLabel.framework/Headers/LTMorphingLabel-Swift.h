...
@property (nonatomic, weak) IBOutlet id <LTMorphingLabelDelegate> __nullable delegate;
...
@protocol LTMorphingLabelDelegate
@optional
- (void)morphingDidStart:(LTMorphingLabel * __nonnull)label;
- (void)morphingDidComplete:(LTMorphingLabel * __nonnull)label;
- (void)morphingOnProgress:(LTMorphingLabel * __nonnull)label :(float)progress;
@end
